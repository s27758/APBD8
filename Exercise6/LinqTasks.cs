...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            var defaultValue = new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null };
            var result = Emps.Select(emp => new { emp.Ename, emp.Job, emp.HireDate })
                             .Union(new[] { defaultValue });
            return result;
        }
    ...
    {
        // Extension method to get employees with direct reports, sorted by Ename ascending and Salary descending
